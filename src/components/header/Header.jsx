							...
							<div className='header-option'>
								<div className='header-optionItem'>
									...
									<div className='option-container'>
										...
										<button className='option-btn' onClick={() => handleOption('adult', 'i')}>
											+
										</button>
									</div>
								</div>
								<div className='header-optionItem'>
									...
									<div className='option-container'>
										...
										<button className='option-btn' onClick={() => handleOption('infant', 'i')}>
											+
										</button>
									</div>
								</div>
								<div className='header-optionItem'>
									...
									<div className='option-container'>
										...
										<button className='option-btn' onClick={() => handleOption('room', 'i')}>
											+
										</button>
									</div>
								</div>
